...
def main():
    ...
    #     ["BRAIN DCT LAM", 11000, "EGLL_S_APP"],
    #     ["COWLY DCT BNN", 11000, "EGLL_S_APP"],
    # ])
    ...
    # ])
    stdTransit(masterCallsign, controllerSock, 80, [
    ...
    # ], withMaster=False)
    # stdDeparture(masterCallsign, controllerSock, "EGCC", 100, [  # NT departures
